...
import { ChartBarIcon, DocumentTextIcon, CalendarDaysIcon, ClockIcon, AcademicCapIcon, CheckIcon, TrashIcon, CheckSquareIcon, UserGroupIcon, ShieldCheckIcon, PencilIcon, LockClosedIcon, PlusCircleIcon, ListBulletIcon, EyeIcon, ArrowUturnLeftIcon, CheckCircleIcon, InformationCircleIcon } from './Icons';
...
export const MyDashboard: React.FC<MyDashboardViewProps> = (props) => {
    ...
    type DashboardTab = 'kinerja' | 'rapot' | 'aktivitas-pribadi' | 'bimbingan' | 'panel-mentor' | 'persetujuan' | 'presensi-tim';
